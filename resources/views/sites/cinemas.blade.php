...
<div class="warper-content">
    <div class="page--news cinema--background">
        <div class="container">
            <h1 class="about--us-title-title">Hệ Thống Rạp</h1>
            <div>
                    ...
                    @if (isset($cinemas))
                        @foreach($cinemas as $cinema)
                            ...
                            <div class="news--item">
                                    ...
                                    <a href="javascript:fbShare('{{ route('cinema', ['id' => $cinema->id]) }}', 'Fb Share', 'Facebook share popup', '', 520, 350)" class="btn--share">Chia sẻ</a>
                                </div>
                            </li>
                        @endforeach
                    @endif
